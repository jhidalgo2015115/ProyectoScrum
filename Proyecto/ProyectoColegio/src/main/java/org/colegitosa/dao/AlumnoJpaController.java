...
import org.colegitosa.dao.exceptions.PreexistingEntityException;
...
public class AlumnoJpaController implements Serializable {
    ...
    public AlumnoJpaController() {
        this.emf = Persistence.createEntityManagerFactory("Conexion");
    }
    ...
    public void editarAlumno(Alumno alumno) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
